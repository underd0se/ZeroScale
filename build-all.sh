...
zig cc -target arm-linux-musleabihf -O2 -s -std=c99 -D_GNU_SOURCE -D_DEFAULT_SOURCE -Iinclude \
    src/main.c src/config.c src/ui.c -o bin/release/zeroscale-tui-v0.1.0-armv7-linux-musl
...
zig cc -target aarch64-linux-musl -O2 -s -std=c99 -D_GNU_SOURCE -D_DEFAULT_SOURCE -Iinclude \
    src/main.c src/config.c src/ui.c -o bin/release/zeroscale-tui-v0.1.0-arm64-linux-musl

# Copy ARMv7 to default local binary
cp bin/release/zeroscale-tui-v0.1.0-armv7-linux-musl bin/zeroscale-tui-armv7
